(function () {
  ...
  DOMTree.prototype = {
    ...
    //key = is just the fucking attribute name
      //add your code here
    ...
    children: function(selector) {
      ...
      if (!selector) {
        ...
        //var kids = []
        for (var i = 0; i < this.htmlElements.length; i++) {
           chirren.push(this.htmlElements[i].children)
         }

         // this.each (function (elem) {
         //   chirren.push(elem.children)
         // })

         // chirren.map (function (childs, index) { 
         //    kids.push(childs)
         // })

         return chirren

      } //else { chirren.filter(function (value, index) { })  }
