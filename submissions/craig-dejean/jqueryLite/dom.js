(function () {
  ...
  DOMTree.prototype = {
    ...
    append: function(string) {
      //add your code here
      this.htmlElements.push(string);
    

    },
    //jQuery .attr: http://api.jquery.com/attr/
    //If no 'value' argument is passed into this function, it should just return the attribute (that matches the 'key' 
    //  that's passed in as the first argument of the function) of the first element in the 'this.htmlElements' array
