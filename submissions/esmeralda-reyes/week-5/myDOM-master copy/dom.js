(function () {
  ...
  //////////////////////////////////////////////////////////
//another way of writing DOMTree.prototype.each = function ()
  DOMTree.prototype = {
    ...
    each: function (callback) {
      ...
      // }
      //using forEach
      //looping through all out elements on the page
    ...
    html: function (string) {
      ...
      //use .innerHTML
      if(!string){
        //want to return first element in our array similar to how the real .html function works
        return this.htmlElements[0].innerHTML;
        //this else statement does what .html would do if two arguments were passed to it
      } else{
    ...
    remove: function() {
      //add your code here
      this.each(function(){
        (this.htmlElements).splice(0, this.length);
      })
    },
...
//will immediately call the function once the document is loaded