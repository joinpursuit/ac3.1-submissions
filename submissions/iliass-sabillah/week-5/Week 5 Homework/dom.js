(function () {
  ...
  DOMTree.prototype = {
    ...
    remove: function() {
      //add your code here
       this.each(function(elem){
          // elem.splice(this.indexOf(elem),1);
    ...
    append: function(string) {
      //add your code here
        // var tag= document.createElement(string.substring(1,string.indexOf('>')));
        // console.log("tag ",tag);
        // var text = string.substring(string.indexOf(">")+1,string.indexOf('/')-1);
        // text= document.createTextNode(text);
        // console.log("text: ", text);
        // console.log('L141', 'tag:',tag)
        // string= tag.appendChild(text);

        this.each(function(elem){
          elem.innerHTML+= string; 
           console.log(this);
          // elem.appendChild(string);
          // this.htmlElements(elem); 
         })
    ...
    children: function(selector) {
      ...
      var arr=[];
     if(!selector){
        var array=[].slice.call(this.htmlElements);
       for(var i=0; i< this.htmlElements.length;i++){
             arr.push(array[i].innerHTML)
      }
      return arr;
    }
