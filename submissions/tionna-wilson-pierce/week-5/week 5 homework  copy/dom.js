(function () {
  ...
  DOMTree.prototype = {
    ...
    //It will be helpful to do this first because you can use it in a bunch of other function
    ...
    //This function should remove the class that's passed in as the 'className' argument from each each of the elements in the `this.htmlElements` array
    ...
    //jQuery .parent function: https://api.jquery.com/parent/ (LETS GET BACK TO THESE LATER)
    parents: function() {
      //add your code here
      //use .parentNode
