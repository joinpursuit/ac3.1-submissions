(function () {
  ...
  function DOMTree(elements){
    ...
    this.htmlElements = elements; // pushing elements into this.htmlElements array
  };
  ...
  DOMTree.prototype = {
    ...
    //If thre IS a a string passed in as an argument, this function should replacce the innerHTML of each element in the `this.htmlElements` array with
    ...
    empty: function() {
      ...
      // console.log(this);
      this.each(function (elem) { // this.htmlElements not required, already part of our .each()
        elem.innerHTML = "";
      })
      // this.each(function(elem){
      //   elem.html(""); // Uncaught TypeError: elem.html is not a function()
      // })
    ...
    on: function (event, fn) {
      ...
      this.each(function (elem) {
        elem.addEventListener(event, function(){
          console.log("You've clicked on: " + this.className)
        });
      });
    },
