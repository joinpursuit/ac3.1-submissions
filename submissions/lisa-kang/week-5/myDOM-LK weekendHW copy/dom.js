(function () {
  ...
  DOMTree.prototype = {
    ...
    each: function (callback) {
      //add your code here //loop over all elements and apply a function
      // for (var i = 0; i < this.htmlElements.length; i++) {
      //   callback(this.htmlElements[i])
      //   //to call it in console ie: "$d("img").each(function(){console.log("this is working")})" it will log "this is working" 5x bc there are 5 imgs
      // }

      this.htmlElements.forEach(function(element) {
        callback(element)
      })
      // this.htmlElements is an array
    },
    ...
    html: function (string) { //SHOW HTML ELEMENTS
      //add your code here
      //use .innerHTML
        if(!string) {
    ...
    empty: function() { //REMOVE inside, tags still exist (innerHTML)
      //add your code here
    ...
    //   //add your code here  ul.appendChild(stringLI)
...
   },
    ...
    attr: function (key, value) { //id, hah 
      //add your code here
    ...
    on: function (event, fn) {
      ...
      //in window $d('li').on('click', function(){console.log("hello")})
    ...
    children: function(selector) {
      //add your code here
      //return this.htmlElements[0].children
      var childrenArr = [];
      this.each(function(element){
        childrenArr.push(element.children)
      })
      return childrenArr
    },
